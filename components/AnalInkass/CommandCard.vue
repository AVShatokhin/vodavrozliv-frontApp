<template>
  <div class="my-user-item-container" v-if="item.cashierInkass == true">
    <md-button
      v-if="item.isPrihod == false"
      @click.native="showPrihodDialog = true"
      class="md-success my-md-button"
    >
      <span class="material-icons"> task_alt </span>
      Оприходовать
      <md-dialog-confirm
        :md-active.sync="showPrihodDialog"
        md-title="Подтвердите операцию"
        md-content="Оприходовать инкассацию?"
        md-confirm-text="Оприходовать"
        md-cancel-text="Отмена"
        @md-cancel="showPrihodDialog = false"
        @md-confirm="prihodItem(true)"
      />
    </md-button>
    <md-button
      v-else
      @click.native="showUnPrihodDialog = true"
      class="md-default my-md-button"
    >
      <span class="material-icons"> redo </span>
      Вернуть
      <md-dialog-confirm
        :md-active.sync="showUnPrihodDialog"
        md-title="Подтвердите операцию"
        md-content="Отменить оприходование инкассации?"
        md-confirm-text="Выполнить операцию"
        md-cancel-text="Отмена"
        @md-cancel="showUnPrihodDialog = false"
        @md-confirm="prihodItem(false)"
      />
    </md-button>
    <md-button
      v-if="item.isPrihod == false"
...
export default {
  ...
  data() {
    return {
      ...
      showPrihodDialog: false,
      showUnPrihodDialog: false,
