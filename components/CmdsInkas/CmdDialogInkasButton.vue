...
export default {
  ...
  data() {
    return {
      ...
      commandsLocation: [
        [
          { cmd: "inkas1", showDialog: false },
          { cmd: "inkas2", showDialog: false },
          { cmd: "inkas3", showDialog: false },
        ],
        [
          { cmd: "inkas4", showDialog: false },
          { cmd: "inkas5", showDialog: false },
          { cmd: "inkas6", showDialog: false },
        ],
        [{ cmd: "inkas7", showDialog: false }],
      ],
    };
  },
  methods: {
