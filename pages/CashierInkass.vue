...
import TerminalCard from "../components/CashierInkass/TerminalCard.vue";
import FilterCard from "../components/CashierInkass/FilterCard.vue";
import SimpleDatePicker from "../components/common/SimpleDatePicker.vue";
import DataCard from "../components/CashierInkass/DataCard.vue";
import CommandCard from "../components/CashierInkass/CommandCard.vue";
import PodItog from "../components/CashierInkass/PodItog.vue";
